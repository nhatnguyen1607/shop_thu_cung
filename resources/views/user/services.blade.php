...
<div class="body">
    ...
    <div class="service-text mb30">
        <div class="service-text__content">
            ...
            <h2 class="h2-title">Chăm sóc toàn diện, tận tâm và xuất phát từ tình yêu với thú cưng chính là tôn chỉ của mọi dịch vụ luôn sẵn sàng đón tiếp quý khách!</h2>
        </div>
