    ...
    <nav id="sidebar" class="sidebar js-sidebar">
      <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
          <li class="sidebar-header">Mục lục</li>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{URL::to('/admin/thanhvien')}}">
          ...
          <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="{{ route('admin_logout')}}"><i class="align-middle me-2" data-feather="log-out"></i> <span class="align-middle">Đăng xuất</span></a>
              </div>
            </li>
          </ul>
        </div>
