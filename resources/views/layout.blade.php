    ...
    <footer>
        <div class="footer__info">
            <div class="footer__info-content">
                <h4>Sơ lược về shop</h4>
                <p>Shop Thú Cưng của chúng tôi là nơi cung cấp đa dạng các loài thú cưng đáng yêu như chó, mèo và phụ kiện chăm sóc chuyên nghiệp. Với phương châm "Mang yêu thương đến mọi nhà", chúng tôi cam kết đem đến những người bạn bốn chân khỏe mạnh, đáng yêu cùng các dịch vụ tận tâm. Hãy đến để tìm kiếm người bạn đồng hành hoàn hảo cho gia đình bạn!</p>
            </div>

            <div class="footer__info-content">
                <h4>Danh mục</h4>
                <p><a href="#spnb">Sản phẩm nổi bật</a></p>
                <p><a href="{{URL::to('/thucung')}}">Thú cưng</a></p>
                <p><a href="{{route('viewAll')}}">Tất cả sản phẩm</a></p>
            </div>
            <div class="footer__info-content">
                <h4>Liên hệ</h4>
